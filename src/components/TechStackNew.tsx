...
const techStack: TechItem[][] = [
  // Row 1 - 12 items (languages, core web)
  [
  ...
  // Row 3 - 8 items (DevOps, Cloud, Ecosystems)
  [
  ...
  // Row 4 - 6 items (Utilities, Tooling)
  [
    ...
    { name: "Ollama", icon: "https://img.icons8.com/color/48/artificial-intelligence.png", url: "https://ollama.ai" },
    { name: "LangChain", icon: "https://img.icons8.com/color/48/brain.png", url: "https://langchain.com" },
  ],
  // Row 5 - 4 items (Key Focus Models & Concepts)
  [
    { name: "SAM 2", icon: "https://img.icons8.com/color/48/analytics.png", url: "https://github.com/facebookresearch/sam2" },
    { name: "YOLO", icon: "https://img.icons8.com/color/48/cctv.png", url: "https://ultralytics.com" },
    { name: "RAG Systems", icon: "https://img.icons8.com/color/48/search--v1.png", url: "https://en.wikipedia.org/wiki/Retrieval-augmented_generation" },
    { name: "Computer Vision", icon: "https://img.icons8.com/color/48/eye.png", url: "https://opencv.org" },
  ],
  // Row 6 - 2 items (Pillars)
  [
    { name: "Agentic AI", icon: "https://img.icons8.com/color/48/bot.png", url: "https://en.wikipedia.org/wiki/Software_agent" },
    { name: "Product Engineering", icon: "https://img.icons8.com/color/48/services.png", url: "https://en.wikipedia.org/wiki/Product_engineering" },
  ],
];
